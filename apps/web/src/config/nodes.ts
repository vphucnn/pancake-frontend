...
import { opbnbTestnet, linea, sepoliaETHTestnet, pools, poolsTest } from './chains'
...
export const SERVER_NODES = {
  ...
  [ChainId.POOLS]: pools.rpcUrls.public.http,
  [ChainId.POOLS_TEST]: poolsTest.rpcUrls.public.http,
